...
$sql2 = "SELECT COUNT(*) as NbTemperature FROM test WHERE numeroUtilisateur = '$id' AND  capteur = 'Temperature'";
$res2 = $db->prepare($sql2);
$res2->execute();
$resultat2 = $res2->fetch();
$nbTotalTest = $resultat2['NbTemperature'];

switch ($_SESSION['langue']) {
    case 'francais':
        ?>
        <div id="titre"> Mes tests de mesure de la température de la peau</div>
        <?php
        echo "<div id='sous_titre'>" . ' Nombre de test(s) effectué(s) : ' . $nbTotalTest . "</div>";
        break;
    case 'anglais':
        ?>
        <div id="titre">My skin temperature tests</div>
        <?php
...
if ($nbTotalTest == 0) {
    if ($_SESSION['langue'] == 'francais') {
        echo '<div class="Texte"> Vous n\'avez effectué aucun test de la temperature de la peau ! N\'attendez plus ! </div>';
    } else {
        echo '<div class="Texte"> You haven\'t done any skin temperature tests! Do not wait any longer ! </div>';
    }
} else {
    $sql3 = "SELECT COUNT(*) as NbTestValide FROM test WHERE numeroUtilisateur = '$id' AND capteur = 'Temperature' 
            AND validation = 'oui'";
    ...
    switch ($nbTotalTest) {
        ...
        case $nbTotalTest % 2 == 0:
            ...
            capteur = 'Temperature' ORDER BY dateTest DESC LIMIT 0,$moitie ");
            $allIDGauchePair->execute();

            $allIDDroitePair = $db->prepare("SELECT * FROM test WHERE numeroUtilisateur = '$id' 
            AND capteur = 'Temperature' ORDER BY dateTest DESC LIMIT $moitie,$nbTotalTest ");
            ...
            <div class="supportClientGauche">
                ...
                while ($row = $allIDGauchePair->fetch()) {
                    ...
                    <div class="BoutonClient">
                        ...
                        if ($_SESSION['langue'] == 'francais') {
                            echo "<p id='infoTemp'>" . "Temperature fixe à " . $row['score'];
                        } else {
                            echo "<p id='infoTemp'>" . "Fixed temperature at " . $row['score'];
                        }
                        ?>
                        <img src="../images/courbeTemp.png" id="courbeTemp" alt="">
                        <?php
            ...
            <div class="supportClientDroite">
                ...
                while ($row2 = $allIDDroitePair->fetch()) {
                    ...
                    <div class="BoutonClient">
                        ...
                        if ($_SESSION['langue'] == 'francais') {
                            echo "<p id='infoTemp'>" . "Temperature fixe à " . $row2['score'];
                        } else {
                            echo "<p id='infoTemp'>" . "Fixed temperature at " . $row2['score'];
                        }
                        ?>
                        <img src="../images/courbeTemp.png" id="courbeTemp" alt="">
                        <?php
            ...
            <div class="supportClientGauche">
                ...
                while ($row3 = $allIDGaucheImpair->fetch()) {
                    ...
                    <div class="BoutonClient">
                        ...
                        if ($_SESSION['langue'] == 'francais') {
                            echo "<p id='infoTemp'>" . "Temperature fixe à " . $row3['score'];
                        } else {
                            echo "<p id='infoTemp'>" . "Fixed temperature at " . $row3['score'];
                        }
                        ?>
                        <img src="../images/courbeTemp.png" id="courbeTemp" alt="">
                        <?php
            ...
            <div class="supportClientDroite">
                ...
                while ($row4 = $allIDDroiteImpair->fetch()) {
                    ...
                    <div class="BoutonClient">
                        ...
                        if ($_SESSION['langue'] == 'francais') {
                            echo "<p id='infoTemp'>" . "Temperature fixe à " . $row4['score'];
                        } else {
                            echo "<p id='infoTemp'>" . "Fixed temperature at " . $row4['score'];
                        }
                        ?>
                        <img src="../images/courbeTemp.png" id="courbeTemp" alt="">
                        <?php
